const CACHE='ytm-crew-ledger-20260918-4';
const CORE=['./','./index.html','./styles.css','./app.js','./vendor/supabase-lite.js','./config.js','./manifest.webmanifest','./roster-print.html','./restore.html','./assets/icon.svg','./assets/ytm-logo.svg'];
